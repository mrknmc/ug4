...
"""
hadoop jar /opt/hadoop/hadoop-0.20.2/contrib/streaming/hadoop-0.20.2-streaming.jar -input /user/s1250553/ex1/matrixLarge.txt -output /user/s1140740/task_7.out -mapper mapper.py -file mapper.py -reducer reducer.py -file reducer.py -partitioner org.apache.hadoop.mapred.lib.KeyFieldBasedPartitioner -jobconf map.output.key.field.separator=. -jobconf num.key.fields.for.partition=1

hadoop dfs -cat /user/s1140740/task_7.out/* | sort -n | cut -d $'\t' -f 2
"""
