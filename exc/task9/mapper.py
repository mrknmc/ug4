...
"""
hadoop jar /opt/hadoop/hadoop-0.20.2/contrib/streaming/hadoop-0.20.2-streaming.jar -input /user/s1250553/ex1/uniLarge.txt -output /user/s1140740/task_9.out -mapper mapper.py -file mapper.py -reducer reducer.py -file reducer.py

hadoop dfs -cat /user/s1140740/task_9.out/* | sort -nr | awk 'BEGIN{max=0}{if($1>=max){print $2; max=$1}}'
"""
